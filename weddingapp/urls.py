...
from .views import create_event, EventList, EventDetail, GuestList, GuestDetail, delete_guest

urlpatterns = [
    path('', views.EventList.as_view(), name='home'),
    path('create_event/', create_event, name='create_event'),
    path('edit_event/<str:pk>/', views.EventDetail.as_view(), name='edit_event'),
